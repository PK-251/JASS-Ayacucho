...
<a class="nav-link-app {{ $active === 'ingresos' ? 'active' : '' }}" href="{{ route('admin.ingresos.index') }}">
    <span class="nav-icon"><svg viewBox="0 0 24 24"><path d="m22 7-8.5 8.5-5-5L2 17"/><path d="M16 7h6v6"/></svg></span>Ingresos
</a>
<a class="nav-link-app {{ $active === 'egresos' ? 'active' : '' }}" href="{{ route('admin.egresos.index') }}">
...
<a class="nav-link-app {{ $active === 'multas' ? 'active' : '' }}" href="{{ route('admin.multas.index') }}">
...
<a class="nav-link-app {{ $active === 'reportes' ? 'active' : '' }}" href="{{ route('admin.reportes.index') }}">
...
<a class="nav-link-app {{ $active === 'asistencia' ? 'active' : '' }}" href="{{ route('admin.asistencia.index') }}">
